...
if PYINSTALLER:
    ...
    params["entry_points"] = {
        "console_scripts": [
            f"{__appname__} = {__packagename__}.app:main"
        ]
    }

GITHUB_URL = "https://github.com/oleksis/youtube-dl-gui/"
if __name__ == "__main__":
    setup(
        name=f"{__appname__}".replace("-", "_"),
        version=__version__,
        description=DESCRIPTION,
        long_description=LONG_DESCRIPTION,
        long_description_content_type="text/markdown",
        url=__projecturl__,
        download_url=f"{GITHUB_URL}releases/latest",
        project_urls={
            "Source": GITHUB_URL,
